...
public:
   ...
   /* returns pointer to the answer */
    ...
    void setMyLabelOrder(int *myorder);

     void setParameters(int numParam, void *param);

    //add a new command passing the table of graphs for each label 
    void setEnergies(Energy *e);

    Energy* getEnergies();

    void setSolutions(int *solutions);
...
protected:
    ...
    Energy    *m_energies;
    int       *m_solutions;
    Energy::Var *m_variables;// = (Energy::Var *) new Energy::Var[m_nLabels];
